...
<body onload="window.print();">
    <div id="page" class="page">
        <div class="row header">
            <div class="logo col-5"><img src="../images/logovanthanh.png" class="img-fluid" /></div>
            <div class="company text-center col-7">
                <p><b>CỬA HÀNG XE MÁY VĂN THANH</b></p>
                <span>Địa chỉ: 127 Đồng Kè, phường Hóa Khánh Bắc, quận Liên Chiểu, thành phố Đà Nẵng</span><br>
                <span>ĐT: 0387895020</span><br>
                <span>Email: tranvanthanh281199@gmail.com</span><br>
            </div>
        </div>
        <hr />
